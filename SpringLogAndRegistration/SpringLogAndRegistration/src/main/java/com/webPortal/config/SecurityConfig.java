...
import com.webPortal.service.LoginServiceImpl;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	 ...
	 protected void configure(HttpSecurity http) throws Exception{
	  ...
	  http.authorizeRequests().antMatchers("/login", "/user/registration", "/user/register").permitAll();
